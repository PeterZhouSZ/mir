...
#ifndef CROSSENTROPYLOSSLAYERIMPL_CUDNN_H
#define CROSSENTROPYLOSSLAYERIMPL_CUDNN_H
...
class CrossEntropyLossLayerImpl_cudnn : public CrossEntropyLossLayer
{
    public:
        CrossEntropyLossLayerImpl_cudnn(ConvNetImpl_cudnn &convNet, std::string name);
...
#endif // CROSSENTROPYLOSSLAYERIMPL_CUDNN_H
