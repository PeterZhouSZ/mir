...
#ifndef VIEWRECALLMATCHINGHISTOGRAMTRIPLETLOSSCROSSVAL_H
#define VIEWRECALLMATCHINGHISTOGRAMTRIPLETLOSSCROSSVAL_H
...
#endif // VIEWRECALLMATCHINGHISTOGRAMTRIPLETLOSSCROSSVAL_H
